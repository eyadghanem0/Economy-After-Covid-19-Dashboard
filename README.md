...
This report addresses the changes in economy after the covid-19 pandemic.
Key eonomic indicators were used to create a comparative and interactive 
dashboard. Also, each country's currency was compared to USD from 2020 
...
The datset is licensed and available on Kaggle for free. Access the data
...
completed in 2 days. The Power BI file (.pbix) is recommended to experience
the full interactivity of the report, and a pdf file is added as another option.
